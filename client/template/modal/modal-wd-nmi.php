<div class="modal fade" id="modal-wd-nmi" style="background-color: #0000008a;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="" method="post" id="form-withdraw-nmi">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <a href="javascript:void(0)" id="sendOtpNmi" class="btn btn-secondary">Kirim OTP</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#form-withdraw-nmi').on('submit', function(event) {
            event.preventDefault();
            let button = $(this).find('button[type="submit"]');
            button.addClass('loading');

            $.post("/ajax/post/withdrawal/wallet/wallet-nmi", $(this).serialize(), (resp) => {

<div class="row">
    <div class="col-md-8 mx-auto">
        <form method="post" id="form-disclosure-1">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row mt-3">
                                <div class="col-6 mt-3">
                                    ...
                                    <input type="radio" name="aggree" value="Ya" class="form-check-input radio_css" style="margin-top: 10px;" required <?= !empty($realAccount['ACC_F_DISC']) ? "checked" : "" ?>>
                                ...
                                <div class="col-6 mt-3">
                                    ...
                                    <input type="text" name="agg_date" readonly required value="<?= retnull("ACC_F_DISC_DATE", date('Y-m-d H:i:s')) ?>" class="form-control text-center mb-3 <?= empty($realAccount['ACC_F_DISC_DATE'])? "realtime-date" : "" ?>">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#form-disclosure-1").on('submit', function(event) {
            ...
            $.post("/ajax/regol/pernyataanPengungkapan_1", data, function(resp) {
                if(!resp.success) {

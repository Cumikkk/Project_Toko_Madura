            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2 text-center"><a href="/export/surat-pernyataan?acc=<?php echo md5(md5(App\Models\Account::realAccountDetail(App\Models\Helper::form_input($_GET['id'] ?? "-"))['ID_ACC'])) ?>" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View</a></div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-2">-</div>
                        <div class="col-md-8">
                    ...
                    <!-- <div class="row mb-3">
                        ...
                        <div class="col-md-2 text-center"><a href="/export/all?acc=<?php echo md5(md5(App\Models\Account::realAccountDetail(App\Models\Helper::form_input($_GET['id'] ?? "-"))['ID_ACC'])) ?>" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View</a></div>
                    </div> -->
                </div>
            </div>
        </div>

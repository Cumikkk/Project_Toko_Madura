        ...
        <div class="input-group-a dashboard-filter">
            <?php if($user['MBR_EMAIL'] == "kholidhikam1@gmail.com") : ?>
                <p class="mb-0">
                    ...
                    <?php if($user['MBR_DEPOSIT_STATUS']) : ?>
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        $('.btnStatus').on('click', function() {
                            ...
                            Swal.fire({
                                title: `${typeString} Deposit`,
                                text: `Are you sure you want to ${typeString.toLowerCase()} the Deposit feature on all user?`,
                                icon: "question",
                                ...
                                if(result.isConfirmed) {
                                    ...
                                    $.post("/ajax/post/deposit/toggle-status", {type: type}, (resp) => {
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            let table = $('#deposit-table').DataTable({
                ...
                columnDefs: [
                    { targets: 6, className: "text-center", searchable: false}
                ],
                drawCallback : (tbl) => {
                    // $(`#fbd`).remove();
                    if(!$(`#fbd`).length){
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <div class="alert alert-warning mt-3" role="alert">
                                You don't have any real account yet. Please create a real account to access the deposit feature.
                            </div>
                        </div>
                    </div>
                </div>

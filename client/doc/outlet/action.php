...
try {
    ...
    if ($action === 'get_detail') {
        ...
        $resDetail = $db->query("SELECT o.*, u.username, u.nama_lengkap, u.no_hp, mw.provinsi, mw.kabupaten, mw.kecamatan, mw.kelurahan, u.id_wilayah, u.alamat_lengkap as alamat_outlet FROM outlet o JOIN users u ON o.id_users = u.id_users LEFT JOIN master_wilayah mw ON u.id_wilayah = mw.id_wilayah WHERE o.id_outlet = {$idOutlet} AND o.id_investor = {$investorId} LIMIT 1");

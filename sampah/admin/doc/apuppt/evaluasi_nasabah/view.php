...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">Evaluasi Nasabah</h2>
        <ol class="breadcrumb">
            ...
            <table id="table2" class="table table-striped table-hover" width="100%">
                <thead>
                    <tr>
                        ...
                        <th style="vertical-align: middle" class="text-center">DTTOT/DPPSPM</th>
                        <th style="vertical-align: middle" class="text-center">PEP</th>
...
<script>
    $(document).ready(() => {
        ...
        let tbl = $('#table2').DataTable( {
            ...
            ajax: {
                url: "/ajax/datatable/apuppt/evaluasi_nasabah/view",

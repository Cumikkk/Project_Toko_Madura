                        ...
                        <tr>
                            <td>
                                <div style="color:#0b0b16;direction:ltr;font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif;font-size:16px;font-weight:400;letter-spacing:0;line-height:150%;text-align:center">
                                    <p style="margin:0">Kami ingin menginformasikan bahwa permintaan deposit Anda sebesar <b><?= $jumlah ?? 0 ?></b> dan saat ini transaksi sedang diproses. Mohon menunggu notifikasi selanjutnya setelah proses selesai dan saldo Anda diperbarui.</p>
                                </div>
                            </td>
                        </tr>
                    </tbody>

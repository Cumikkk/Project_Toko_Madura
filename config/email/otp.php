                        ...
                        <tr>
                            <td>
                                <div style="color:#0b0b16;direction:ltr;font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif;font-size:16px;font-weight:400;letter-spacing:0;line-height:150%;text-align:center">
                                    <p style="margin:0">To continue registration and create your trading account, please confirm your email address, OTP code is only valid for <?= $otpMinute ?? 5 ?> minutes.</p>
                                </div>
                            </td>
                        </tr>
                    </tbody>

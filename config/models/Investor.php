...
class Investor {
    ...
    public static function getAllInvestors($loggedInLevel = 1, $loggedInId = 1) {
        ...
        $sql = "
            ...
            LEFT JOIN outlet o ON (o.id_investor = i.id_investor AND (o.status = 'active' OR (o.status IN ('pending', 'reject') AND o.tipe_request = 'perpanjangan')) AND (o.tgl_jatuh_tempo IS NULL OR DATE(o.tgl_jatuh_tempo) >= CURRENT_DATE()))
            {$whereClause}

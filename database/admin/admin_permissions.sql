...
CREATE TABLE `admin_permissions` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_ap_module` (`module_id`),
  CONSTRAINT `fk_ap_module` FOREIGN KEY (`module_id`) REFERENCES `admin_module` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2026-08-18 12:25:33

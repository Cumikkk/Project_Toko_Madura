...
<html>
    ...
    <body>
        ...
        <div class="section">
            FORMULIR PBK. CDDS. 02.1<br><br>
            <p class="text-center" style="padding: 2px;">PERNYATAAN TELAH MELAKUKAN SIMULASI<br>PERDAGANGAN BERJANGKA KOMODITI</p><br>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><strong><?= date('d-m-Y H:i', strtotime(App\Models\Account::realAccountDetail(($acc ?? ""))["ACC_F_SIMULASI_DATE"])) ?></strong></td>
                </tr>
            </table>

...
<body>
    ...
    <div class="section">
        ...
        <div style="text-align:center;vertical-align: middle;padding: 10px 0 10px 0;">
            PERJANJIAN PEMBERIAN AMANAT<br>
            (KHUSUS UNTUK TRANSAKSI KONTRAK DERIVATIF<br>
            DALAM SISTEM PERDAGANGAN ALTERNATIF)
        </div>
        <p class="text-justify">Pada hari ini <?= $date_day ?>, tanggal <?= date('d', strtotime(App\Models\Account::realAccountDetail(($acc ?? ""))["ACC_F_PERJ_DATE"])) ?>, bulan <?= $date_month ?>, tahun <?= date('Y', strtotime($realAccount["ACC_F_PERJ_DATE"])) ?>, bertempat di
            Kantor Pusat atau Kantor Cabang resmi 1) Pialang Berjangka <?= $COMPANY_PRF["COMPANY_NAME"] ?> dengan alamat <?= $COMPANY_MOF["OFC_ADDRESS"] ?>, kami yang mengisi perjanjian di bawah ini:</p>
        <table width="100%">
            <tr>
        ...
        <table width="100%">
            ...
            <tr>
                <td width="1%" style="padding:0px 5px;white-space:nowrap;"> Pekerjaan / Jabatan </td>
                <td width="1%" style="padding:0px 5px;white-space:nowrap;"> : </td>
                <td>Wakil Pialang Berjangka<br>(Petugas Wakil Pialang yang Ditunjuk
                    Memverifikasi)</td>
            </tr>
            <tr>
                <td width="1%" style="padding:0px 5px;white-space:nowrap;vertical-align: top;"> Alamat </td>
        ...
        <p class="text-justify">dalam hal ini bertindak untuk dan atas nama <?= $COMPANY_PRF["COMPANY_NAME"] ?> yang selanjutnya
        ...
        <ol>
            ...
            <li style="page-break-before: always;" class="text-justify">
                ...
                <ul type=1 class="text-justify">
                    <li>Setiap transaksi Nasabah dilaksanakan secara elektronik on-line
                        oleh Nasabah yang bersangkutan;</li>
                    <li>Setiap amanat Nasabah yang diterima dapat langsung
                        ...
                        sebelum memberikan amanat untuk transaksi berikutnya.</li>
                    <li>Setiap transaksi Nasabah secara bilateral dilawankan dengan
                        Penyelenggara Sistem Perdagangan Alternatif <?= $COMPANY_PRF["COMPANY_NAME"] ?>
                        yang telah memiliki Perjanjian Kerjasama dengan Pialang Berjangka.</li>
                    <li>Nasabah bertanggung jawab atas keamanan dan penggunaan
            ...
            <li class="text-justify">
                ...
                <ul type=1 class="text-justify">
                    <li>Nasabah wajib memelihara/memenuhi tingkat Margin yang harus
                        ...
                        Berjangka.</li>
                    <li>Apabila jumlah Margin memerlukan penambahan maka Pialang
                        Berjangka wajib memberitahukan dan memintakan kepada
                        Nasabah untuk menambah Margin segera.</li>
                    <li>Apabila jumlah Margin memerlukan tambahan (<i>Call Margin</i>) maka
                        Nasabah wajib melakukan penyerahan <i>Call Margin</i> selambatlambatnya sebelum dimulai hari perdagangan berikutnya.
                        Kewajiban Nasabah sehubungan dengan penyerahan <i>Call Margin</i>
                        tidak terbatas pada jumlah Margin awal.</li>
                    <li>Pialang Berjangka tidak berkewajiban melaksanakan amanat
                        untuk melakukan transaksi yang baru dari Nasabah sebelum <i>Call Margin</i>
                        dipenuhi.</li>
                    <li>Untuk memenuhi kewajiban <i>Call Margin</i> dan keuangan lainnya
                        dari Nasabah, Pialang Berjangka dapat mencairkan dana Nasabah
                        yang ada di Pialang Berjangka.</li>
                </ul>
                <div style="vertical-align: top;"><input type="checkbox" checked="true" value="YA" /> Saya sudah membaca dan memahami</div>
            </li>
            <li class="text-justify">
            ...
            <li class="text-justify">
                ...
                <ul type=1 class="text-justify">
                        ...
                        <table width="100%" style="margin-left:5px;">
                            ...
                            <?php if ($admBanks) : ?>
                                <?php foreach (mysqli_fetch_all($admBanks, MYSQLI_ASSOC) as $bkadm) : ?>
                                    ...
                                    <tr>
                                        <td colspan="3" style="margin-top: 7px;"></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </table>
                    ...
                    <li>Semua surat berharga, kekayaan lainnya, atau komunikasi harus
            ...
            <li class="text-justify">
                ...
                <ul type=1 class="text-justify">
                    ...
                    <li>Kantor atau kantor cabang Pialang Berjangka terdekat dengan
                    ...
                    <li>Apabila perselisihan dan perbedaan pendapat yang timbul tidak
                        dapat diselesaikan secara musyawarah untuk mencapai mufakat,
                        maka Para Pihak sepakat untuk menyelesaikan perselisihan
                        melalui Badan Arbitrase Perdagangan Berjangka Komoditi (BAKTI)
                        dengan prosedur beracara khusus terkait dengan Penerimaan
                        Nasabah Secara Elektronik Online Dengan Mekanisme Customer
                        Due Diligence (CDD) Sederhana sesuai dengan peraturan BAKTI.</li>
                </ul>
                <div style="vertical-align: top;"><input type="checkbox" checked="true" value="YA" /> Saya sudah membaca dan memahami</div>
            </li>
            <li class="text-justify">
        ...
        <div style="margin-top:25px;text-align:center;">
            ...
            <div>Dengan mengisi kolom “YA” di bawah,<br>saya menyatakan bahwa saya telah menerima</div>
            <div>“PERJANJIAN PEMBERIAN AMANAT TRANSAKSI KONTRAK BERJANGKA“</div>

            ...
            <div style="text-align:center; margin-top: 10px;">
                ...
                <table width="50%" style="text-align: center; margin: auto;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;"><?= date('d-m-Y', strtotime(App\Models\Account::realAccountDetail(($acc ?? ""))["ACC_F_PROFILE_DATE"])) ?></td>
                    </tr>
                </table>
                <!-- <p>IP Address: <?= App\Models\Account::realAccountDetail(($acc ?? ""))["ACC_F_PROFILE_IP"] ?></p> -->
            </div>
        </div>
    </body>
</html>
...
<html>
    ...
    <body>
        ...
        <div class="section">
            ...
            <div style="margin-top:10px;padding: 6px; background-color: #edebe0;"><strong>DATA PRIBADI</strong></div>
            <table class="table no-border" style="margin-top: 10px;">
                <tbody>
                    ...
                    <tr>
                        <td width="35%" class="v-align-middle">Kewarganegaraan</td>
                        <td width="3%" class="v-align-middle">:</td>
                        <td class="v-align-middle"><?= $realAccount['ACC_F_APP_KEWARGANEGARAAN'] ?> </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="3%" class="v-align-middle">:</td>
                        <td class="v-align-middle"><?= $realAccount['ACC_F_APP_PRIBADI_IBU'] ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="35%" class="v-align-middle">Pendidikan *)</td>
                        <td width="3%" class="v-align-middle">:</td>
                        <td class="v-align-middle"><?= $realAccount['ACC_F_APP_PENDIDIKAN'] ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="3%" class="v-align-middle">:</td>
                        <td class="v-align-middle"><?= $realAccount['ACC_F_APP_PENGINVT'] ?>, <?= $realAccount['ACC_F_APP_PENGINVT_BIDANG'] ?></td>
                    </tr>
                </tbody>
            </table>
            <div style="margin:5px;">Apakah Anda memiliki anggota keluarga yang bekerja di BAPPEBTI/Bursa Berjangka/Kliring Berjangka?<br><i>Tidak</i></div>
            <div style="margin:5px;">Apakah Anda telah dinyatakan pailit oleh Pengadilan?<br><i>Tidak</i></div>
        </div>
        <div class="break-before section">
            <div style="margin-top:10px;padding: 6px; background-color: #edebe0;"><strong>PIHAK YANG DIHUBUNGI DALAM KEADAAN DARURAT</strong></div>
            <div style="margin:5px;">Dalam keadaan darurat, pihak yang dapat dihubungi</div>
            ...
            <div style="margin-top:10px;padding: 6px; background-color: #edebe0;"><strong>PEKERJAAN</strong></div>
            <table class="table no-border">
                <tbody>
                    <tr>
            ...
            <div style="margin-top:10px;padding: 6px; background-color: #edebe0;"><strong>DAFTAR KEKAYAAN</strong></div>
            <table class="table no-border">
                </tbody>
                    <tr>
                        <td width="35%" class="v-align-middle">Sumber Penghasilan</td>
                        <td width="3%" class="v-align-middle">:</td>
                        <td class="v-align-middle"><?= $realAccount['ACC_F_APP_KEKYAN_SUMBER_PENGHASILAN'] ?></td>
                    </tr>
                    <tr>
        ...
        <div class="break-before section">
            <div style="margin-top:10px;padding: 6px; background-color: #edebe0;"><strong>REKENING BANK NASABAH UNTUK PENYETORAN DAN PENARIKAN MARGIN</strong></div>
            <div style="margin:5px;">Rekening Bank Nasabah Untuk Penyetoran dan Penarikan Margin (hanya rekening dibawah ini yang dapat Saudara pergunakan untuk lalulintas margin)</div>
            <table class="table no-border">
                <tbody>
            ...
            <div style="margin-top:10px;padding: 6px; background-color: #edebe0;"><strong>DOKUMEN YANG DILAMPIRKAN</strong></div>
            <table class="table no-border">
                <tbody>
                    <tr>
                        <td width="35%" class="v-align-middle"><?= $realAccount['ACC_F_APP_FILE_TYPE'] ?></td>
                        <td width="3%" class="v-align-middle">:</td>
                        <td class="v-align-middle" style="text-align: left !important;">Hasil Scan/photo (Lampirkan)</td>
                    </tr>
                    <tr>
                        <td width="35%" class="v-align-middle">Dokumen Pendukung Lainnya</td>
                        <td width="3%" class="v-align-middle">:</td>
                        <td class="v-align-middle">Hasil Scan/photo (Lampirkan)</td>
                    </tr>
                    <tr>
                        <td width="35%" class="v-align-middle">Foto Terbaru</td>
                        <td width="3%" class="v-align-middle">:</td>
                        <td class="v-align-middle">Hasil Scan/photo (Lampirkan)</td>
                    </tr>
                    <tr>
                        <td width="35%" class="v-align-middle">Foto Identitas (<?= $realAccount['ACC_TYPE_IDT'] ?>)</td>
                        <td width="3%" class="v-align-middle">:</td>
                        <td class="v-align-middle">Hasil Scan/photo (Lampirkan)</td>
                    </tr>
                </tbody>
            </table>
            <div style="margin-top:10px;padding: 6px; background-color: #edebe0;"><strong>PERNYATAAN KEBENARAN DAN TANGGUNG JAWAB</strong></div>
            <div style="margin:5px;">Dengan mengisi kolom “YA” di bawah ini, saya menyatakan bahwa semua informasi dan semua dokumen yang saya lampirkan dalam APLIKASI PEMBUKAAN REKENING TRANSAKSI SECARA ELEKTRONIK ONLINE adalah benar dan tepat, Saya akan bertanggung jawab penuh apabila dikemudian hari terjadi sesuatu hal sehubungan dengan ketidakbenaran data yang saya berikan.</div>
            <div style="margin:5px;">
                <p style="margin: 0px;">Pernyataan Kebenaran dan Tanggung Jawab: Ya</p>
                <p style="margin-bottom: 0px;">Menyatakan pada Tanggal: <?= date("Y-m-d H:i", strtotime($realAccount['ACC_F_APP_DATE'])) ?></p>

<?php
    ...
    $COMP_PROF   = CompanyProfile::profilePerusahaan();
    $company     = $COMP_PROF['COMPANY_NAME'];
    ...
    $amountIDR = ($depositData["DPWD_CURR_TO"] == "IDR") 
        ? $depositData['DPWD_AMOUNT'] 
        : $depositData['DPWD_AMOUNT'] * $rate;
...
<html>
    ...
    <body>
        ...
        <div class="section" style="padding: 0px;">
            <h4 class="text-center" style="margin: 0px;">NOTA PENERIMAAN WITHDRAWAL</h4>
            <table class="table no-border" style="margin-top: 20px; font-size: 15px;">
                <tbody>
                    <tr>
                        <td width="30%" class="v-align-top">Tanggal</td>
                        <td width="3%" class="v-align-top">:</td>
                        <td class="v-align-top"><?= date("d M Y", strtotime($depositData['DPWD_DATETIME'])) ?></td>
                    </tr>
                    <tr>
            ...
            <p style="font-size: 15px; margin-left: 5px;">Detail Withdrawal : </p>
                            ...
                            <table class="table" style="font-size: 15px; border: 1px solid black;">
                                <thead>
                                    <tr style="border: 1px solid black;">
                                        <td style="border: 1px solid black !important;" class="text-center">Nominal Withdrawal dalam US Dollar</td>
                                        <td style="border: 1px solid black !important;" class="text-center">Rate <br> (dalam Rupiah)</td>
                                        <td style="border: 1px solid black !important;" class="text-center">Nominal Withdrawal <br> dalam Rupiah</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>

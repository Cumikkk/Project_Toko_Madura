<div class="table-repsonsive">
    <table class="table table-hover table-striped">
        <tbody>
            ...
            <tr>
                <td>4.</td>
                <td>FORMULIR PBK. CDDS. 03</td>
                <td>
                    Pernyataan Pengungkapan (<i>Disclosure Statement</i>)<br>
                    <small>Menyatakan telah memahami poin-poin krusial dalam Pernyataan Pengungkapan (Disclosure Statement) secara sadar.</small>
                </td>
                <td><a target="_blank" href="/export/pernyataan-pengungkapan?acc=<?php echo $id_acc; ?>" class="btn btn-primary d-flex align-items-center"><i class="fa fa-eye"></i>&nbsp;View</a></td>
            </tr>
            <tr>
                <td>5.</td>
                <td>FORMULIR PBK. CDDS. 04</td>
                <td>

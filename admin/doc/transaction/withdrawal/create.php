<div class="page-header">
    <div>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/transaction/withdrawal/view">Withdrawal</a></li>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p>Deal Type <i>Auto</i> meaning the system will automatically make a withdrawal to MetaTrader and generate and save a Deal ID without requiring manual input from the user.</p>
    
                <p class="mb-0 fw-bold">Manual</p>
                <p>Deal Type <i>Manual</i> means the system does not make withdrawal to MetaTrader. Users are required to fill in the Deal ID manually, and the system will save the Deal ID according to the value entered in the Deal ID column.</p>
            </div>
        </div>
    </div>
    <div class="col-md-8 mb-3">
        <form action="" method="post" id="form-manual-withdrawal">
            <input type="hidden" name="key" value="<?= sprintf("%s_%s", "withdrawal", uniqid()) ?>">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title text-primary">Form Manual Withdrawal</h5>
                </div>        
                <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#form-manual-withdrawal').on('submit', function(event) {
            ...
            $.ajax({
                url: "/ajax/post/transaction/withdrawal/create",
                type: "post",
                dataType: "json",
                ...
                Swal.fire(resp.alert).then(() => {
                    if(resp.success) {
                        location.href = '/transaction/withdrawal/view';
                    }
                })

<?php if($permisCreate = $adminPermissionCore->isHavePermission($moduleId, "create.detail.symbolcategory")){ ?>
    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modal-create-category" class="btn btn-primary btn-sm btn-icon-text"><i class="fas fa-plus"></i> Add Category</a>

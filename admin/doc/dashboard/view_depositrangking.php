...
<script type="text/javascript">
    (function() {
        ...
        function initDepositRangking() {
            if (tabel_DepositRangking) {
                tabel_DepositRangking.destroy();
            }
            ...
            tabel_DepositRangking = $('#tabel_DepositRangking').DataTable({
                ...
                ajax: {
                    ...
                    error: function(xhr, error, code) {
                        console.error('Deposit Ranking fetch error:', error);
                    }
                },
                columns: [
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', initDepositRangking);
        } else {
            // Delay initialization to prevent blocking main thread
            setTimeout(initDepositRangking, 100);
        }
    })();
</script>
...
<script type="text/javascript">
    (function() {
        ...
        function initBalanceRangking() {
            if (tabel_BalanceRangking) {
                tabel_BalanceRangking.destroy();
            }
            ...
            tabel_BalanceRangking = $('#tabel_BalanceRangking').DataTable({
                ...
                ajax: {
                    ...
                    error: function(xhr, error, code) {
                        console.error('Balance Ranking fetch error:', error);
                    }
                },
                columns: [
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', initBalanceRangking);
        } else {
            // Delay initialization to prevent blocking main thread
            setTimeout(initBalanceRangking, 100);
        }
    })();
</script>
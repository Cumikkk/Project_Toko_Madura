        ...
        <div class="main-header-center">
            <div class="responsive-logo">
                <a href="<?= SystemInfo::app('ADMIN_URL') ?>/dashboard" class="d-inline-flex align-items-center gap-2 text-decoration-none">
                    <div class="d-flex align-items-center justify-content-center shadow-sm" style="background: #7D0A0A; color: #ffffff; min-width: 30px; height: 30px; border-radius: 8px; font-size: 15px;">
                        <i class="fa-sharp fa-solid fa-shop"></i>
                    </div>
                    <div class="d-flex flex-column text-start">

<?php
    ...
    if(!$adminPermissionCore->hasPermission($authorizedPermission, "/account/edit_other")) {
        JsonResponse([
            'code'      => 200,
            'success'   => false,
    ...
    $UPDATE_DATA = [
        "ACC_F_APP_TUJUANBUKA"   => $data["o-tujuan-pembukaan-rekening"],
        "ACC_F_APP_PENGINVT"     => $data["o-pengalaman-investasi"],
        "ACC_F_APP_KEKYAN"       => $data["o-daftar-kekayaan"]
    ];

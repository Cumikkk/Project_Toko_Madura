...
$update = $db->query("UPDATE outlet SET status = 'active', tanggal_disetujui = NOW(), tanggal_bergabung = NOW(), tgl_jatuh_tempo = DATE_ADD(NOW(), INTERVAL 1 MONTH) WHERE id_outlet = {$idOutlet}");
if ($update) {
